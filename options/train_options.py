...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=32000, help='frequency of showing training results on screen')
        parser.add_argument('--print_freq', type=int, default=320, help='frequency of showing training results on console')
        ...
        parser.add_argument('--which_epoch', type=str, default='70', help='which epoch to load? set to latest to use latest cached model')
